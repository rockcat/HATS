...
export const BUILTIN_CATALOGUE: MCPCatalogueEntry[] = [
  ...
  },
  {
    ...
    description: 'Access Gmail, Google Docs, Drive, Calendar, Sheets, Slides, and Chat — official Gemini CLI extension',
    category: 'productivity',
    config: {
      transport: 'stdio',
      command: 'node',
    ...
    notes: 'Requires Gemini CLI with the Google Workspace extension installed. Run: gemini extensions install https://github.com/gemini-cli-extensions/workspace — then authenticate with your Google account on first use.',
